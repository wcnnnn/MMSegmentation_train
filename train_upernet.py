...
def main():
    ...
    # 使用ResNet18的UperNet配置
    cfg = Config.fromfile('configs/upernet/upernet_r18_4xb4-80k_ade20k-512x512.py')
    
    # 修改配置
    cfg.work_dir = './work_dirs/upernet_r18_ade20k'
    ...
    # 检查点设置
    cfg.default_hooks.checkpoint.interval = 4000
